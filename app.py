...
class Ui_MainWindow(object):
    ...
    def db_connect(self, config):
        try:
            ...
            self.statusMessage.setText("Successful connection!")
            self.set_databases()
            return mydb
        except Exception as e:
            print(e)
            self.statusMessage.setText("Connection error!")

    def create_database(self):
        try:
            db_name = self.databaseNameInput.text()
            mysql_functions.create_database(db_name)
            self.statusMessage.setText("Database {} successfully created!".format(db_name))
            self.set_databases()

        except Exception as e:
            print(e)
            self.message.setText("Error in database creation!")
    ...
    def delete_selected_db(self):
        ...
        for s in selected_indexes:
            ...
            self.statusMessage.setText("Database {} successfully deleted!".format(db_name))

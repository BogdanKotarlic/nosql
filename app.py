...
class MainWindowViewer(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(self.arangoTab)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(2, 5, 231, 471))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.arangoVerticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.arangoVerticalLayout.setContentsMargins(0, 0, 0, 0)
        self.arangoVerticalLayout.setObjectName("arangoVerticalLayout")
        #   Deo za prikaz baze i tabela
        self.arangoTreeWidget = QtWidgets.QTreeWidget(self.verticalLayoutWidget)
        self.arangoTreeWidget.setObjectName("arangoTreeWidget")
        self.arangoTreeWidget.headerItem().setText(0, "Databases:")
        self.arangoTreeWidget.setColumnCount(1)
        self.arangoVerticalLayout.addWidget(self.arangoTreeWidget)
        #   Akcije: konekcija
        self.connectArangoPushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.connectArangoPushButton.setObjectName("connectArangoPushButton")
        self.arangoVerticalLayout.addWidget(self.connectArangoPushButton)
        #   Akcije: brisanje i kreiranje nove baze
        self.deleteArangoPushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.deleteArangoPushButton.setObjectName("deleteArangoPushButton")
        self.arangoVerticalLayout.addWidget(self.deleteArangoPushButton)
        self.createArangoHorizontalLayout = QtWidgets.QHBoxLayout()
        self.createArangoHorizontalLayout.setObjectName("createArangoHorizontalLayout")
        self.newArangoNameLineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.newArangoNameLineEdit.setObjectName("newArangoNameLineEdit")
        self.createArangoHorizontalLayout.addWidget(self.newArangoNameLineEdit)
        self.createArangoPushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.createArangoPushButton.setObjectName("createArangoPushButton")
        self.createArangoHorizontalLayout.addWidget(self.createArangoPushButton)
        self.arangoVerticalLayout.addLayout(self.createArangoHorizontalLayout)
        self.databasesTabWidget.addTab(self.arangoTab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.connectArangoPushButton.setText(_translate("MainWindow", "Connect ArangoDB"))
        ...
        self.deleteArangoPushButton.setText(_translate("MainWindow", "Delete Selected ArangoDB"))
        ...
        self.newArangoNameLineEdit.setPlaceholderText(_translate("MainWindow", "New ArangoDB Name"))
        ...
        self.createArangoPushButton.setText(_translate("MainWindow", "Create"))
